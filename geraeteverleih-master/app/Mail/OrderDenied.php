    ...
    <mj-body background-color="#fafbfe" width="600px">
        <mj-wrapper background-color="#fff" padding="0" css-class="body-section">
            ...
            <mj-section mj-class="text-container">
                <mj-column>
                    <mj-text mj-class="h1" align="center">Bestellung abgelehnt</mj-text>
                    <mj-divider border-color="#eef2f7"></mj-divider>
                    <mj-text align="center">Die Bestellung vom '. $this->order->from->isoFormat("Do MMMM") .' bis zum ' . $this->order->to->isoFormat("Do MMMM") . ' wurde von '.$this->order->answeredBy->displayName().' abgelehnt.</mj-text>
                    <mj-text align="center">Grund: '.$this->order->comment.'</mj-text>
        ...
        return $this->html($html)
            ->subject("Bestellung wurde abgelehnt");
    }
}
