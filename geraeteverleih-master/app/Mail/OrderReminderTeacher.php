...
class OrderReminderTeacher extends Mailable
{
    ...
    <mj-body background-color="#fafbfe" width="600px">
        <mj-wrapper background-color="#fff" padding="0" css-class="body-section">
            ...
            <mj-section mj-class="text-container">
                <mj-column>
                    <mj-text mj-class="h1" align="center">Erinnerung einer Rückgabe</mj-text>
                    <mj-divider border-color="#eef2f7"></mj-divider>
                    <mj-text align="center">Wir erinnern Sie daran, dass die Bestellung von ' . $this->order->user->displayName() . ' am ' . $this->order->to->isoFormat("Do MMM. YYYY") . ' endet.</mj-text>
        ...
        return $this->html($html)
            ->subject("Rückgabe-Erinnerung: " . $this->order->user->displayName() . ': ' . $this->order->to->isoFormat("Do MMM. YYYY"));
    }
}
