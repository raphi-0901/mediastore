    ...
    <mj-body background-color="#fafbfe" width="600px">
        <mj-wrapper background-color="#fff" padding="0" css-class="body-section">
            <mj-section full-width="full-width" padding="0">
                <mj-column mj-class="bg-success" border-bottom="10px solid #42c29d" width="100%" padding="20px">
                   <mj-image width="30px"
            ...
            <mj-section mj-class="text-container">
                <mj-column>
                    <mj-text mj-class="h1" align="center">Erinnerung zur Rückgabe</mj-text>
                    <mj-divider border-color="#eef2f7"></mj-divider>
                    <mj-text align="center">Wir erinnern Sie daran, dass die Bestellung am ' . $this->order->to->isoFormat("Do MMM. YYYY") . ' endet.</mj-text>
                    <mj-text align="center">Bitte seien Sie verlässlich und retournieren die Geräte fristgerecht!</mj-text>
        ...
        return $this->html($html)
            ->subject("Rückgabe-Erinnerung: " . $this->order->to->isoFormat("Do MMM. YYYY"));
    }
}
