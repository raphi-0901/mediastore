...
class OrderNotificationTeacher extends Mailable
{
    ...
    <mj-body background-color="#fafbfe" width="600px">
        <mj-wrapper background-color="#fff" padding="0" css-class="body-section">
            <mj-section full-width="full-width" padding="0">
                <mj-column mj-class="bg-primary" border-bottom="10px solid #8C9EFF" width="100%" padding="20px">
                   <mj-image width="30px"
            ...
            <mj-section mj-class="text-container">
                <mj-column>
                    <mj-text mj-class="h1" align="center">Bestellung: ' . $this->order->user->displayName() . ', ' . $this->order->user->class . '</mj-text>
                    <mj-divider border-color="#eef2f7"></mj-divider>
                    <mj-text align="center">Es wurde eine Bestellung aufgegeben, für die Sie zuständig sind.</mj-text>
                     <mj-button mj-class="bg-primary" href="'. route('orders.show', $this->order->id) .  '">Ansehen</mj-button>
                    <mj-text align="center">Bitte vergessen Sie nicht darauf, die Bestellung zu bearbeiten!</mj-text>
                    <mj-divider border-color="#eef2f7" padding="20px"></mj-divider></mj-column>
            </mj-section>
        ...
        return $this->html($html)
            ->subject('Bestellung: ' . $this->order->user->displayName() . ', ' . $this->order->user->class);
    }
}
