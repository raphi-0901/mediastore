...
class OrderDurationOverdrawn extends Mailable
{
    ...
    <mj-head>
        <mj-attributes>
            ...
            <mj-class name="bg-danger" background-color="#d93434"/>
    ...
    <mj-body background-color="#fafbfe" width="600px">
        <mj-wrapper background-color="#fff" padding="0" css-class="body-section">
            <mj-section full-width="full-width" padding="0">
                <mj-column mj-class="bg-danger" border-bottom="10px solid #c73030" width="100%" padding="20px">
                   <mj-image width="30px"
            ...
            <mj-section mj-class="text-container">
                <mj-column>
                    <mj-text mj-class="h1" align="center">Bestelldauer überzogen!</mj-text>
                    <mj-divider border-color="#eef2f7"></mj-divider>
                    <mj-text align="center">Die Bestellung von ' . $this->order->user->displayName() . ' wurde nicht fristgerecht zurückgegeben!</mj-text>
                    <mj-text align="center">Setzen Sie sich bitte mit dem Schüler in Kontakt.</mj-text>
                    <mj-button mj-class="bg-danger" href="'. route('orders.show', $this->order->id) .  '">Ansehen</mj-button>
        ...
        return $this->html($html)
            ->subject("Dauer überzogen: " . $this->order->user->displayName());
    }
}
