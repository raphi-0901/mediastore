...
var Html5Qrcode = function () {
    ...
    return _createClass(a, [{
        key: "start", value: function (b, c, d, e) {
            ...
            var i = null != h.qrbox, j = document.getElementById(this._elementId),
            ...
            var m = function (a, b) {
                ...
                var d = i && c <= b, e = d ? f._getShadedRegionBounds(a, b, c) : {x: 0, y: 0, width: a, height: b},
                    k = f._createCanvasElement(e.width, e.height), l = k.getContext("2d");
                ...
                return new Promise(function (b, c) {
                    ...
                    if (g._localMediaStream = a, !h.aspectRatio) d(); else {
...
var Html5QrcodeScanner = function () {
    ...
    return _createClass(a, [{
        ...
        key: "__createSectionControlPanel", value: function () {
            ...
            g.innerHTML = "Berechtigung anfordern", g.addEventListener("click", function () {
                g.disabled = !0, b.__setStatus("PERMISSION"), b.__setHeaderMessage("Berechtigung anfordern..."), Html5Qrcode.getCameras().then(function (c) {
        ...
        key: "__renderCameraSelection", value: function (b) {
            ...
            e.innerHTML = "Kamera auswählen (".concat(b.length, ") &nbsp;"), e.style.marginRight = "10px";
            var f = document.createElement("select");
            f.classList.add('form-control');
            f.classList.add('select2');
            f.setAttribute('toggle', 'select2');
            ...
            n.innerHTML = "Scannen starten", m.appendChild(n);
            n.classList.add('btn');
            ...
            o.classList.add('mt-2');
            o.innerHTML = "Scannen stoppen", o.style.display = "none", o.disabled = !0, m.appendChild(o), d.appendChild(m), n.addEventListener("click", function () {
        ...
        key: "__createSectionSwap", value: function () {
            var b = this, c = "Bild scannen", d = "Mit Kamera scannen",
        ...
        key: "_showHideScanTypeSwapLink", value: function (a) {
            ...
            !0 !== a && (a = !1), this.sectionSwapAllowed = a, this.__getDashboardSectionSwapLink().style.display = a ? 'none' : "none";
        }
    }, {
