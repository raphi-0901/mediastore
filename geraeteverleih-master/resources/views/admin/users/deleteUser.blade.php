    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header modal-colored-header bg-danger">
                <h4 class="modal-title"><span id="dUserName"></span> löschen</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <form id="deleteForm" autocomplete="off" class="form-horizontal">
                <div class="modal-body">
                    <div>Möchten Sie diesen Benutzer wirklich löschen?</div>
                </div>
                <div class="modal-footer">
                    <div class="form-group">
                        <button type="button" class="btn btn-light" data-dismiss="modal">Abbruch</button>
                        <div id="btnDeleteUser" class="btn btn-danger text-white" data-dismiss="modal">Löschen</div>
                    </div>
